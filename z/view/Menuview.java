...
//Set Icon
        ImageIcon icon1 = new ImageIcon("oop_project\\z\\icon\\rabbit.png");
        ImageIcon icon2 = new ImageIcon("oop_project\\z\\icon\\strawberry.png");     
        ImageIcon icon3 = new ImageIcon("oop_project\\z\\icon\\chocolate_bar.png");       
        ImageIcon icon4 = new ImageIcon("oop_project\\z\\icon\\ledger.png");       
        ImageIcon icon5 = new ImageIcon("oop_project\\z\\icon\\slightly_smiling_face.png");       
        ImageIcon icon6 = new ImageIcon("oop_project\\z\\icon\\man-running.png");
